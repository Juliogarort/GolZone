                ...
                <tbody>
                    @foreach ($productos as $producto)
                        <tr>
                            ...
                            <td>
                                @if ($producto->image)
                                    <img src="{{ asset('img/' . $producto->image) }}" alt="Imagen de {{ $producto->name }}"
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="name" class="form-label fw-bold">Nombre del
                                                            producto</label>
                                                        <input type="text" name="name" id="name"
                                                            class="form-control" value="{{ $producto->name }}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="price" id="price"
                                                            class="form-control" value="{{ $producto->price }}"
                                                            step="0.01" required>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="liga" class="form-select">
                                                            <option value="Premier League"
                                                                {{ $producto->liga == 'Premier League' ? 'selected' : '' }}>
                                                                Premier League</option>
                                                            <option value="LaLiga"
                                                                {{ $producto->liga == 'LaLiga' ? 'selected' : '' }}>LaLiga
                                                            </option>
                                                            <option value="Serie A"
                                                                {{ $producto->liga == 'Serie A' ? 'selected' : '' }}>Serie
                                                                A</option>
                                                            <option value="Bundesliga"
                                                                {{ $producto->liga == 'Bundesliga' ? 'selected' : '' }}>
                                                                Bundesliga</option>
                                                            <option value="Ligue 1"
                                                                {{ $producto->liga == 'Ligue 1' ? 'selected' : '' }}>Ligue
                                                                1</option>
                                                            <option value="Eredivise"
                                                                {{ $producto->liga == 'Eredivise' ? 'selected' : '' }}>
                                                                Eredivise</option>
                                                            <option value="Liga AFA"
                                                                {{ $producto->liga == 'Liga AFA' ? 'selected' : '' }}>Liga
                                                                AFA</option>
                                                            <option value="Selección"
                                                                {{ $producto->liga == 'Selección' ? 'selected' : '' }}>
                                                                Selección</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="type" class="form-select">
                                                            <option value="Retro"
                                                                {{ $producto->type == 'Retro' ? 'selected' : '' }}>Retro
                                                            </option>
                                                            <option value="Exclusivo"
                                                                {{ $producto->type == 'Exclusivo' ? 'selected' : '' }}>
                                                                Exclusivo</option>
                                                            <option value="Estandar"
                                                                {{ $producto->type == 'Estandar' ? 'selected' : '' }}>
                                                                Estandar</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        @if ($producto->image)
                                                            <div class="mt-2">
                                                                ...
                                                                <img src="{{ asset('img/' . $producto->image) }}"
                                                                    alt="Imagen actual" class="img-thumbnail mt-2"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <img id="imagePreview" src="#" alt="Vista previa"
                                                class="mt-3 img-fluid d-none" style="max-width: 200px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
