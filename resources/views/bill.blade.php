    ...
    <div class="invoice-box">
        ...
        <div class="d-flex justify-content-between mb-4">
            ...
            <div class="customer-info text-start">
                ...
                <p><strong>Teléfono:</strong> {{ Auth::user()->phone ?? 'No disponible' }}</p> <!-- Asumiendo que el teléfono puede no estar disponible -->
            </div>
        ...
        <style>
            .table tfoot tr td {
                width: 150px; /* Ancho específico para las filas de IVA y TOTAL */
            }
        </style>
        ...
        <div class="payment-info mt-4">
            ...
            <p><strong>Fecha de la compra:</strong> {{ now()->setTimezone('Europe/Madrid')->format('d/m/Y H:i') }}</p> <!-- Formato de fecha en zona horaria de España -->
        </div>
    </div>
